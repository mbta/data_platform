defmodule ExCubicIngestion.Repo.Migrations.AddingTables20260716 do
  use Ecto.Migration
  ...
  @ods_tables [
    %{
      name: "cubic_ods_qlik__ec_stage_metric_history",
      s3_prefix: "cubic/ods_qlik/EC_STAGE.METRIC_HISTORY/"
    },
  ]
