defmodule ExCubicIngestion.Repo.Migrations.AddRevLossTable do
  use Ecto.Migration
  ...
  @ods_table_name "cubic_ods_qlik__edw_revenue_loss_assessment"
  @ods_table_s3_prefix "cubic/ods_qlik/EDW.REVENUE_LOSS_ASSESSMENT/"
