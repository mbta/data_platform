defmodule ExCubicIngestion.Repo.Migrations.AddDeviceLastStateTable do
  use Ecto.Migration
  ...
  @ods_table_name "cubic_ods_qlik__edw_device_last_state"
  @ods_table_s3_prefix "cubic/ods_qlik/EDW.DEVICE_LAST_STATE/"
