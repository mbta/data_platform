defmodule ExCubicIngestion.Repo.Migrations.AddTokenHistoryTable do
  use Ecto.Migration
  ...
  @ods_table_name "cubic_ods_qlik__edw_token_history"
  @ods_table_s3_prefix "cubic/ods_qlik/EDW.TOKEN_HISTORY/"
