defmodule ExCubicIngestion.Utility do
  @moduledoc """
  Module for holding helpful functions
  """

  @spec is_valid_date(String.t()) :: boolean()
  def is_valid_date(date_str) do
    match?({:ok, _date}, Date.from_iso8601(date_str))
  end

  @spec is_valid_datetime(String.t()) :: boolean()
  def is_valid_datetime(datetime_str) do
