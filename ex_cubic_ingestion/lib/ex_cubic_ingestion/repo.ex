defmodule ExCubicIngestion.Repo do
  use Ecto.Repo,
    otp_app: :ex_cubic_ingestion,
  ...
  @doc """
  Set via the `:configure` option in the ExCubicIngestion.Repo configuration, a function
  ...
  def before_connect(config) do
    repo_config = Application.get_env(:ex_cubic_ingestion, ExCubicIngestion.Repo, [])
