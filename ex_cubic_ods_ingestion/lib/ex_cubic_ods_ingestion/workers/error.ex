defmodule ExCubicOdsIngestion.Workers.Error do
  @moduledoc """
  ...
  def perform(%{args: args} = _job) do
    ...
    error_bucket = Application.fetch_env!(:ex_cubic_ods_ingestion, :s3_bucket_error)
    error_prefix = Application.fetch_env!(:ex_cubic_ods_ingestion, :s3_bucket_prefix_error)
